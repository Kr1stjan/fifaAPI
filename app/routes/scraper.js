...
module.exports = function(app, db) {
    ...
    */
    app.get('/scrape', (req, res) => {
        ...
        for(i=1;i<=pages;i++){
            // Callback interface
            scrapeIt("https://www.fifaindex.com/teams/"+ i +"/?league=350&league=1&league=56&league=13&league=19&league=20&league=335&league=66&league=10&league=14&league=60&league=61&league=382&league=351&league=349&league=83&league=341&league=54&league=53&league=336&league=308&league=7&league=16&league=17&league=39&league=111&league=353&league=4&league=189&league=76&league=67&league=65&league=50&league=31&league=32&league=68&league=41&league=80&order_by=overallrating", {
                teams: {
                ...
                for(i=0;i<page.teams.length;i++){
                    ...
                    logger.info("Saved team: " + team.name + " league: " + team.league + " rating: " + team.overallRating);
                    })
                }
            });
        }
